            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <a
                            v-if="user.info?.lnkedin"
                            :href="user.info.lnkedin"
                            target="_blank"
                            rel="noopener"
                            class="social-button"
                        >
                        ...
                        <a
                            v-if="user.info?.instagram"
                            :href="user.info.instagram"
                            target="_blank"
                            rel="noopener"
                            class="social-button"
                        >
        ...
        <Modal v-if="isProfileInfoModal" @close="isProfileInfoModal = false">
            <template #body>
                ...
                >
                    ...
                    <ProfileForm
                        :user="user"
                        @cancel="isProfileInfoModal = false"
...
const address = computed(() => {
    const parts = [props.user?.info?.city, props.user?.info?.country].filter(
        Boolean,
    );
    return parts.join(', ');
});
