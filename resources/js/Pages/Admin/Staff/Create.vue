<template>
    <AdminLayout title="New Staff">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Create a new staff account. The 
                    <span class="font-mono">staff</span>ole will be automatically assigned once the account is created.
                </p>
            </div>
            <Link
        ...
        >
            ...
            <!-- Basic info -->
            <section class="space-y-5 border-b border-gray-100 p-6 dark:border-gray-800">
