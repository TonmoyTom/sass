                ...
                <form class="flex flex-col gap-5" @submit.prevent="submit">
                    ...
                    >
                        ...
                        <div class="flex items-center gap-5">
                            <div
                                class="flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800"
                            >
                                <img
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-400">
                                    PNG, ICO, JPG. Recommended 32x32px. Max
                                    512KB.
                                </p>
                                <p
                                    v-if="logoError"
...
const faviconUrl =
    props.settings?.favicon_url ?? props.settings?.favicon ?? null;
const saved = ref(false);

// Page props.errors theke directly nao - eta remount hole o survive kore
const logoError = computed(() => page.props.errors?.logo ?? null);
const faviconError = computed(() => page.props.errors?.favicon ?? null);
