<template>
    <WorkspaceLayout title="Roles">
        <div class="mx-auto">
            ...
            <!-- table (search + sort + pagination shob DataTable e handled) -->
...
// path ta apnar actual DataTable component location onujayi thik korun
import DataTable from '@/Components/ui/DataTable.vue';
import { router } from '@inertiajs/vue3';
import { ref } from 'vue';

defineProps({
    roles: { type: Object, required: true }, // ekhon paginated object (data, links, ...)
