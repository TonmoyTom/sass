...
<template>
    <WorkspaceLayout title="Site Settings">
        <div class="mx-auto">
            ...
            >
                <div v-if="settings.length" class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr
                                class="border-b border-gray-200 bg-gray-50 text-left dark:border-gray-700 dark:bg-white/[0.02]"
                            >
                                <th
                                    class="p-4 font-medium text-gray-600 dark:text-gray-400"
                                >
                                    Page
                                </th>
                                <th
                                ...
                                <th
                                    class="p-4 text-right font-medium text-gray-600 dark:text-gray-400"
                                >
                                    Action
                                </th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="p-4">
                                    ...
                                    >
                                        <Link
                                            :href="`/settings/seo/${setting.id}/edit`"
                ...
                >
                    ...
                    >
                        Kono page ekhono add kora hoy nai
                    </p>
                    <p class="mt-1 text-sm text-gray-400">
                        "Add New Page" click kore শুরু koro
                    </p>
                </div>
            </div>
        </div>
