...
const props = defineProps({
    settings: Object, // paginator object: { data, links, meta, ... }
    filters: Object,
});
...
const columns = [
    ...
    { key: 'page_url', label: 'URL', sortable: false },
    { key: 'actions', label: 'Action', align: 'right', sortable: false },
];
...
const handleSort = (column) => {
    const isSameColumn = props.filters?.sort_by === column;
    const nextDir =
        isSameColumn && props.filters?.sort_dir === 'asc' ? 'desc' : 'asc';
        ...
        <div class="mx-auto">
            ...
            >
                <DataTable
                    :data="settings"
                    :filters="filters"
                    route-name="tenant.site-settings.index"
                    :columns="[
